		...
		jQuery.ajax({
                ...
                {   
                    response=response.trim();
                      ...
                      if(response == 'present')
                      {
                          document.querySelector('#email_error').innerHTML="Email Id Already Registered";
                      }
	...
	if(is_error=='')
	{
		jQuery.ajax({
                ...
                {   
                   ...
                   if(response == 'invalid')
                   {
                       document.querySelector('.login_msg p').innerHTML="pleaser enter valid details";
                   }
                   if(response == 'valid')
                   {
...
function manage_cart_function(pid,type)
{				
